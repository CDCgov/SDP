...
RUBY_SLAVE=registry.access.redhat.com/openshift3/jenkins-slave-ruby-rhel7
# if the master is running the centos image, use the centos slave images.
if [[ `grep CentOS /etc/redhat-release` ]]; then
  NODEJS_SLAVE=registry.129.83.185.216.xip.io:80/openshift/jenkins-slave-nodejs-centos7
  MAVEN_SLAVE=registry.129.83.185.216.xip.io:80/openshift/jenkins-slave-maven-centos7
  RUBY_SLAVE=registry.129.83.185.216.xip.io:80/openshift/jenkins-slave-ruby-centos7
fi
